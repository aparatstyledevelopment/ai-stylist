...
export default function ProductDetail({
  ...
  return (
    <div className={`product-detail ${closing ? 'closing' : ''}`}>
      ...
      <div className="product-header">
        ...
        <div className="product-header-actions">
          <button className="header-icon-btn" onClick={onOpenCart} aria-label="سبد خرید">
          ...
          <button className="header-icon-btn" onClick={handleClose} aria-label="برگشت">
      ...
      >
        ...
        {currentImage > 0 && (
          <button className="carousel-arrow arrow-right" onClick={() => setCurrentImage((p) => p - 1)}>
        ...
        {currentImage < item.cardColors.length - 1 && (
          <button className="carousel-arrow arrow-left" onClick={() => setCurrentImage((p) => p + 1)}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
