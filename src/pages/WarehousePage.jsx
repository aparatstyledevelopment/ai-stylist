    ...
    <>
      <div className="wh-topbar">
        <div className="search" id="wh-search">
          <input placeholder="جستجو کالا (نام، SKU…)" readOnly />
          <Search />
        </div>
      </div>
      <div className="ob-empty">
        <div className="ob-empty-illus">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" width="32" height="32"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>
        </div>
        <h3>انبار خالیه</h3>
        <p>هنوز هیچ کاشیی اضافه نشده.<br />اولین محصول رو به انبارت اضافه کن.</p>
        <button className="btn primary" onClick={() => goTo('add-tile')}>
          <Plus size={14} />
          اضافه کردن اولین کاشی
        </button>
      </div>
    </>
  );
